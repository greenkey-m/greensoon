...
<html>
	<head>
		...
		<style>
            ...
            .content p, .countdown_section, h1 {
            ...
            body {
                ...
                padding: 0;
                color: #fff;
                background: url('<?php echo $bgimageUrl; ?>') center top;
            ...
            body {
                font-family: '<?php echo $fontcss[0]; ?>';
            }

            .countdown_section, h1 span {
                font-family: '<?php echo $fontcss[1]; ?>';
            }
